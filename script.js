...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Evento do formulário para buscar e salvar livro da Gutendex
...
// Função para carregar e exibir todos os livros salvos
...
// Função para exibir os detalhes do livro retornado
